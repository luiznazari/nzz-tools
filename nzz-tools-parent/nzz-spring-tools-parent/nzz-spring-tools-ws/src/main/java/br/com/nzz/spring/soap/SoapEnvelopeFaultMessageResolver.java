...
final class SoapEnvelopeFaultMessageResolver implements FaultMessageResolver {
	...
	public void resolveFault(WebServiceMessage message) {
		try {
			...
			throw new WebServiceException(NzzConstants.INTEGRATION_ERROR, code, failMessage);
			 ...
			 */
			throw new WebServiceException(e, NzzConstants.INTEGRATION_ERROR,
				NzzConstants.INTERNAL_ERROR, UNKNOWN_ERROR);
		}
	}
