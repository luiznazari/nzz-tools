 ...
 */
@Log4j2
public class MarshallingSoapRequest<P, R> extends AbstractSoapRequest<P, R> implements TypedSoapRequest<P, R> {
	...
	public MarshallingSoapRequest<P, R> withRequestTimeoutInSeconds(Integer requestTimeoutInSeconds) {
		super.withRequestTimeoutInSeconds(requestTimeoutInSeconds);
		return this;
	}
