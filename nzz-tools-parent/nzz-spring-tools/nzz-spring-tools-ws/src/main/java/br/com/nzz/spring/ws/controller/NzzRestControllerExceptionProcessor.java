package br.com.nzz.spring.ws.controller;
...
import br.com.nzz.spring.ws.exception.ApiErrorMessage;
import br.com.nzz.spring.ws.exception.WebServiceEntityNotFoundException;
...
public class NzzRestControllerExceptionProcessor {
	...
	public List<ErrorMessage> exceptionRule(HttpMessageConversionException exception) {
		...
		return new ApiErrorMessage(NzzWsConstants.INVALID_JSON_ERROR, exception.getMessage())
			.asErrorList();
	}
	...
	public List<ErrorMessage> exceptionRule(HttpRequestMethodNotSupportedException exception) {
		return new ApiErrorMessage(NzzWsConstants.INVALID_REQUEST_ERROR, exception.getMessage())
			.asErrorList();
	}
	...
	public List<ErrorMessage> exceptionRule(Exception exception) {
		log.error(exception.getMessage(), exception);
		return new ApiErrorMessage(NzzWsConstants.INTERNAL_ERROR, exception.getMessage())
			.asErrorList();
	}
